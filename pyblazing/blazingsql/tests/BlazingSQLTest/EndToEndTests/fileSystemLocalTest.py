...
def main(dask_client, drill, dir_data_lc, bc, nRals):
    ...
    def executionTest(): 
        ...
        data_types =  [DataType.DASK_CUDF, DataType.CSV, DataType.ORC, DataType.PARQUET] # TODO json
        ...
        for fileSchemaType in data_types:
            ...
            queryId = 'TEST_12'
            query = """select count(n1.n_nationkey) as n1key, count(n2.n_nationkey) as n2key, count(n2.n_nationkey) as cstar from nation as n1 

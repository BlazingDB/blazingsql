...
#from blazingsql.tests.BlazingSQLTest.EndToEndTests.aggregationsWithoutGroupByTest import main
 ...
 #   Execution.getArgs()
  ...
  #  nvmlInit()
   ...
   # bc, dask_client = init_context()
    ...
    #main(dask_client, None, Settings.data['TestSettings']['dataDirectory'], bc, nRals)

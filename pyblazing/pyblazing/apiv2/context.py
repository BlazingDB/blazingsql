...
class BlazingContext(object):
    ...
    def __init__(
        ...
        self.logging_dir_path = "blazing_log"
        ...
        if "BLAZING_LOGGING_DIRECTORY" in config_options:
            self.logging_dir_path = config_options["BLAZING_LOGGING_DIRECTORY"]
        ...
        nodes, node_log_paths = self.initialize_workers()
        self.nodes = nodes
        self.node_log_paths = node_log_paths
            ...
            for worker in list(self.dask_client.scheduler_info()["workers"]):
                dask_futures.append(
                    self.dask_client.submit(
                        ...
                        logging_dir_path=self.logging_dir_path,
                        workers=[worker],
                    )
                )
    ...
    def sql(
        ...
        if self.dask_client is None:
            ...
            if return_futures:
                ...
                meta_results = [f.result() for f in dask_futures]

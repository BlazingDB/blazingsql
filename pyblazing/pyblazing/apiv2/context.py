...
class BlazingContext(object):
    ...
    dask_client : ``Client`` object from ``dask.distributed``. 
    ...
    allocator : string, allowed options are ``"default"``, ``"managed"`` or ``'existing'``

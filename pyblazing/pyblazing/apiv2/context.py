    ...
    def log(self, query, logs_table_name='bsql_logs'):
        ...
        if not self.logs_initialized:
            ...
            log_schemas = {
                ...
                'bsql_kernel_events': (['ral_id', 'query_id', 'kernel_id', 'num_rows', 'num_bytes', 'event_type', 'timestamp_begin', 'timestamp_end'], ['int32', 'int32', 'int32', 'int32', 'int64', 'str', 'int64', 'int64']),
                'bsql_cache_events': (['ral_id', 'query_id', 'source', 'sink', 'num_rows', 'num_bytes', 'timestamp_begin', 'timestamp_end'], ['int32', 'int32', 'int64', 'int64', 'int32', 'int64', 'int64', 'int64']),
            }

...
public class CalciteApplication {
	...
	public static void executeUpdate() throws NamingException, SQLException,
	...
	private static class CalciteApplicationOptions {
		...
		public CalciteApplicationOptions(final Integer tcpPort, final String orchestratorIp, final Integer orchestratorPort) {

 ...
 * The change is about keep the condition "IS TRUE"
 */
...
public abstract class ReduceExpressionsRule extends RelOptRule
  ...
  public static class FilterReduceExpressionsRule extends ReduceExpressionsRule {
    ...
    @Override public void onMatch(RelOptRuleCall call) {
      ...
      // We want to keep this "IS TRUE" condition
      // so basically the only modification for this file is this two lines
      boolean contains_is_true_expr = expList.toString().contains("IS TRUE");
      if (reduceExpressions(filter, expList, predicates, true, matchNullability) && !contains_is_true_expr) {

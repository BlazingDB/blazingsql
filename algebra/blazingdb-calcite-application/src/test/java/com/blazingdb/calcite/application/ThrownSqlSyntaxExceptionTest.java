...
public class ThrownSqlSyntaxExceptionTest extends GetRelationalAlgebraTest {
	public ThrownSqlSyntaxExceptionTest(final String queryString, final String expectedMessage) {
	...
	data() {
		return Arrays.asList(new Object[][] {
			{"select * from heroes whera age=1", "Encountered \"age\" at line 1, column 28."},
			{"select *\n  fram heroes\n  whera age=1\n  limit 1", "Encountered \"heroes\" at line 2, column 8."},
		});
	}

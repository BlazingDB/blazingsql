...
public class BlazingRulesTest {
	...
	createTableSchemas() throws Exception {
		...
		map.put("customer",
			Arrays.asList(new SimpleEntry<>("c_custkey", CatalogColumnDataType.GDF_INT32),
		...
		map.put("region",
			Arrays.asList(new SimpleEntry<>("r_regionkey", CatalogColumnDataType.GDF_INT32),
				new SimpleEntry<>("r_name", CatalogColumnDataType.GDF_STRING),
				new SimpleEntry<>("r_comment", CatalogColumnDataType.GDF_STRING)));
		map.put("nation",
			Arrays.asList(new SimpleEntry<>("n_nationkey", CatalogColumnDataType.GDF_INT32),
		...
		map.put("orders",
			Arrays.asList(new SimpleEntry<>("o_orderkey", CatalogColumnDataType.GDF_INT64),
				new SimpleEntry<>("o_custkey", CatalogColumnDataType.GDF_INT32),
				new SimpleEntry<>("o_orderstatus", CatalogColumnDataType.GDF_STRING),
				new SimpleEntry<>("o_totalprice", CatalogColumnDataType.GDF_FLOAT64),
				new SimpleEntry<>("o_orderdate", CatalogColumnDataType.GDF_DATE64),
				new SimpleEntry<>("o_orderpriority", CatalogColumnDataType.GDF_STRING),
				new SimpleEntry<>("o_clerk", CatalogColumnDataType.GDF_STRING),
				new SimpleEntry<>("o_shippriority", CatalogColumnDataType.GDF_STRING),
				new SimpleEntry<>("o_comment", CatalogColumnDataType.GDF_STRING)));
		map.put("supplier",
			Arrays.asList(new SimpleEntry<>("s_suppkey", CatalogColumnDataType.GDF_INT64),
		...
		map.put("lineitem",
			Arrays.asList(new SimpleEntry<>("l_orderkey", CatalogColumnDataType.GDF_INT64),
				...
				new SimpleEntry<>("l_extendedprice", CatalogColumnDataType.GDF_FLOAT64),
				...
				new SimpleEntry<>("l_receiptdate", CatalogColumnDataType.GDF_DATE64),
				new SimpleEntry<>("l_shipinstruct", CatalogColumnDataType.GDF_STRING),
				new SimpleEntry<>("l_shipmode", CatalogColumnDataType.GDF_STRING),
				new SimpleEntry<>("l_comment", CatalogColumnDataType.GDF_STRING)));
		map.put("part",
			Arrays.asList(new SimpleEntry<>("p_partkey", CatalogColumnDataType.GDF_INT64),
				...
				new SimpleEntry<>("p_retailprice", CatalogColumnDataType.GDF_FLOAT32),
				new SimpleEntry<>("p_comment", CatalogColumnDataType.GDF_STRING)));
		map.put("partsupp",
			Arrays.asList(new SimpleEntry<>("ps_partkey", CatalogColumnDataType.GDF_INT64),
				new SimpleEntry<>("ps_suppkey", CatalogColumnDataType.GDF_INT64),
				new SimpleEntry<>("ps_availqty", CatalogColumnDataType.GDF_INT64),
				new SimpleEntry<>("ps_supplycost", CatalogColumnDataType.GDF_FLOAT32),

...
conda install --yes -c conda-forge -c rapidsai-nightly/label/cuda9.2 libcudf=0.12 cudf=0.12 dask-cudf=0.12 dask-cuda=0.12
```
...
conda install --yes -c conda-forge openjdk=8.0 maven cmake gtest gmock rapidjson cppzmq cython=0.29 jpype1 netifaces pyhive
conda install --yes -c conda-forge -c blazingsql-nightly bsql-toolchain
conda install --yes -c conda-forge -c rapidsai-nightly/label/cuda10.0 libcudf=0.12 cudf=0.12 dask-cudf=0.12 dask-cuda=0.12
```

...
gpuci_conda_retry install --yes openjdk=8.0 maven cmake=3.18.4 gtest=1.10 gmock=1.10 rapidjson cppzmq cython=0.29 jpype1 netifaces pyhive pytest numpy=1.19

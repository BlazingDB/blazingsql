...
conda install --yes -c conda-forge dask-cuda=${MINOR_VERSION} dask-cudf=${MINOR_VERSION} cudf=${MINOR_VERSION} python=$PYTHON_VER cudatoolkit=$CUDA_REL ucx-proc=*=gpu ucx ucx-py

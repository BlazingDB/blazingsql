...
struct MatchWildcardFilterTestParam {
	MatchWildcardFilterTestParam(const std::string & input, const std::string & wildcard, bool match)
		: input(input), wildcard(wildcard), match(match) {}
...
const std::vector<MatchWildcardFilterTestParam> matchWildcardInputs = {
	MatchWildcardFilterTestParam("/percy/camilo/data.txt", "*.txt", true),
	MatchWildcardFilterTestParam("/percy/camilo/data.txt", "*data*", true),
	MatchWildcardFilterTestParam("/percy/camilo/data.txt", "i*", false),
	MatchWildcardFilterTestParam("/blazingdb/rocks/./data.txt", "*", true),
	MatchWildcardFilterTestParam("/blazingdb/rocks/./data.txt", "*simply", false),
	MatchWildcardFilterTestParam("//usr/share/folders/meta.data/data.txt", "*.data*", true)};

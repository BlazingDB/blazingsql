...
INSTANTIATE_TEST_CASE_P(InvalidCommand,
	InvalidParse,
	testing::Values("ill-deregister file system 'test_local_disk'",
		"deregister files system 'test_local_disk'",
		"deregister file sys 'test_local_disk'"
		//

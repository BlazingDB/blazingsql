...
struct Generator {
	Generator(unsigned int id, unsigned int times, const std::string & data) : id{id}, times{times}, data{data} {}

	Generator(Generator && generator) : id{generator.id}, times{generator.times}, data{generator.data} {}

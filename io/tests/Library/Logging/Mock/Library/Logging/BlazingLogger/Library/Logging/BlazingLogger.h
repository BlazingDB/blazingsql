...
namespace Library {
    namespace Logging {
        class BlazingLogger {
        public:
            BlazingTest::Library::Logging::BlazingLoggerMock& getMock() {
                return mock;
            }

            static void setStaticMockOnMethods() {
                useStaticMockOnMethods = true;
            }

            static void setStaticMock(BlazingTest::Library::Logging::BlazingLoggerMock& value) {
                staticMock = &value;
            }

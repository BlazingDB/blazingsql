...
Path GoogleCloudStorage::getRoot() const noexcept { return this->pimpl->root; }
...
std::vector<FileStatus> GoogleCloudStorage::list(
...
std::vector<std::string> GoogleCloudStorage::listResourceNames(
	const Uri & uri, FileType fileType, const std::string & wildcard) const {

...
BlazingException::BlazingException(const std::string & details) { this->details = details; }

BlazingException::~BlazingException() {
	// TODO Auto-generated destructor stub
}

void BlazingException::append(const std::string & newDetails) { this->details = newDetails + "\n" + this->details; }
...
BlazingInvalidPermissionsFileException::BlazingInvalidPermissionsFileException(const Uri & uri)
	: BlazingFileSystemException(details) {

...
inline bool extractDate(const char *data, long sIdx, long eIdx, bool dayfirst,
                 int *year, int *month, int *day);
inline void extractTime(const char *data, long start, long end, int *hour, int *minute,
                 int *second, int *millisecond);

inline constexpr int32_t daysSinceEpoch(int year, int month, int day);
inline constexpr int64_t secondsSinceEpoch(int year, int month, int day, int hour,
 ...
 */
inline long findFirstOccurrence(const char *data, long start_idx, long end_idx,
                         char c) {
...
inline gdf_date32 parseDateFormat(const char *data, long start_idx, long end_idx,
                           bool dayfirst) {
  int day, month, year;
  gdf_date32 e = -1;
 ...
 */
inline gdf_date64 parseDateTimeFormat(const char *data, long start, long end,
                               bool dayfirst) {
  int day, month, year;
...
inline constexpr uint32_t operator"" _days(unsigned long long int days) {
  return days;
}
...
inline constexpr uint32_t operator"" _years(unsigned long long int years) {
  return years;
}

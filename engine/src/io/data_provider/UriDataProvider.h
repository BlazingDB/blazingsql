...
public:
	uri_data_provider(std::vector<Uri> uris, std::vector<std::map<std::string,gdf_scalar> > uri_scalars,std::vector<std::map<std::string,std::string> > string_scalars,std::vector<std::map<std::string,bool> > is_column_string);

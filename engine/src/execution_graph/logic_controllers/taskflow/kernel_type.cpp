...
std::string get_kernel_type_name(kernel_type type){
    switch (type){
        ...
        case kernel_type::SortKernel: return "SortKernel";
        case kernel_type::SplitByKeysKernel: return "SplitByKeysKernel";
        case kernel_type::ConcatPartitionsByKeysKernel: return "ConcatPartitionsByKeysKernel";

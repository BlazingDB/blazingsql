...
cdef extern from "../include/io/io.h":
    ...
    TableSchema parseMetadata(vector[string] files, pair[int,int] offsets, string file_format_hint, vector[string] arg_keys, vector[string] arg_values, vector[pair[string,gdf_dtype]] types) except +raiseParseSchemaError

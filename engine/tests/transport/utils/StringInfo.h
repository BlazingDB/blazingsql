   ...
   public:
    explicit StringInfo(gdf_column *column)
        : nvStrings_{nullptr}, stringsLength_{0}, offsetsLength_{0},
          stringsPointer_{nullptr}, offsetsPointer_{nullptr}, nullBitmask_{nullptr},
          stringsSize_{0}, offsetsSize_{0}, nullMaskSize_{0}, totalSize_{0} {
      ...
      nvStrings_->create_offsets(
          stringsPointer_, offsetsPointer_, nullBitmask_, false);
      totalSize_ =
